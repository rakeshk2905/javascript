const arrayNum = [55, 11, 66, 1, 22, 73];

arrayNum.forEach((currentVlue, index, array) => {
  console.log(currentVlue, index, array);
});

console.log(`using only currentValue`);
arrayNum.forEach((currentVlue) => {
  console.log(currentVlue);
});
...
console.log(`======WAP to get student of even id=====`);
